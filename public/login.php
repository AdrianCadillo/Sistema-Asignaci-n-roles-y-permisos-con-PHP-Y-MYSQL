<?php require '../src/controller/LoginController.php'; 
...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="lib/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">TecnologySoft</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2"!>Bienvenido al sistema 👋</h4>
              <p class="mb-2">Porfavor ingrese sus credenciales</p>

              <form id="formAuthentication" class="mb-3" action="" method="POST">
              <div class="mb-2">
                  <label for="email" class="form-label">Seleccione su perfíl</label>
                  <select name="rol" id="rol" class="form-select" autofocus required autocomplete="rol"> 
                    <option disabled selected> --- Seleccione un rol --- </option>
                    <?php 
                    foreach ($roles as $key => $role) {
                    ?>
                     <option value="<?php echo $role['id_rol']; ?>"><?php  echo $role['name']?></option>
                    <?php } ?>
                  </select>
                </div>
              ...
              if($msg!=""){
                if($msg =="error"){
                    echo '
                     ...
                     Error, tus credenciales son incorrectos.....
                     </div>
                    ';
                }
              }
